...
class PayUPayment {
    ...
    public function setCredentials() {
        if (function_exists('config')) {
            $configDatadata = config('payU');
            $this->paymentMode = $paymentMode = $configDatadata['mode'];
            $key = $configDatadata[$paymentMode]['key'];
            $salt = $configDatadata[$paymentMode]['salt'];
            $successUrl = $configDatadata['surl'];
            $failUrl = $configDatadata['furl'];
    ...
    function makePayment($params) {
        ...
        return $result = $this->pay($params, $this->salt, $this->paymentMode);
    }
    
    function validatePayment($data) {
        $data['surl'] = $this->credentials['surl'];
        $data['furl'] = $this->credentials['furl'];
        $result = $this->response($data, $this->salt);
        return $result;
    }
    ...
    function response($params, $salt) {
        ...
        $result = $response->get_response($params);
        unset($response);
        return $result;
    }
